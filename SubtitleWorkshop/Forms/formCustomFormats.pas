...
begin
  ...
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + ID_CFPDIR + '\') then
    CreateDir(ExtractFilePath(Application.ExeName) + ID_CFPDIR + '\');
  dlgLoad.InitialDir := ExtractFilePath(Application.ExeName) + ID_CFPDIR + '\';
...
begin
  ...
  dlgSave.InitialDir := ExtractFilePath(Application.ExeName) + ID_CFPDIR + '\';
