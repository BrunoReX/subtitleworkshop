...
try
  ...
  try
    ...
    begin
      OCRDefFile := ExtractFilePath(Application.ExeName) + ID_OCRDIR + '\' + cmbOCRFiles.Items[cmbOCRFiles.ItemIndex] + ID_OCREXT;
...
var
  ...
  OCRFile : String;
begin
  OCRFile := ExtractFilePath(Application.ExeName) + ID_OCRDIR + '\' + cmbOCRFiles.Items[cmbOCRFiles.ItemIndex] + ID_OCREXT;
